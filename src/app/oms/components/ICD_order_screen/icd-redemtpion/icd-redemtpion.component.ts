...
@Component({
  selector: 'app-icd-redemtpion',
  templateUrl: './icd-redemtpion.component.html',
  styleUrls: ['./icd-redemtpion.component.css']
})
export class IcdRedemtpionComponent {
selectedProductRadioButton: string = 'ICD taken';
   selectedICDRadioButton: string = 'REDEMPTION';
   selectedRedemtionRadioButton: string = 'Full redemption';
